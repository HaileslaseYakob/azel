...
class Salesforecast(models.Model):
    ...
    company_id = fields.Many2one(
        'res.company', 'Company', default=lambda self: self.env.company,
        index=True, required=True)
    salesforecast_product = fields.One2many('forecast.salesforecastproducts', 'salesforecast_id', 'Salesforecast Products',limit=9)
    salesforecast_items = fields.One2many('forecast.salesforecastproductsitems', 'salesforecast_id', 'Salesforecast Items',limit=10)
    salesforecast_items_grouped = fields.One2many('forecast.salesforecastitemsgrouped', 'salesforecast_id', 'Ingredients summary',limit=8)
